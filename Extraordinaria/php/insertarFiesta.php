...
class insertarFiesta{
    ...
    $consultaPre = $this->db->prepare("INSERT INTO fiesta (nombre, dia, mes, descripcion, concejo) VALUES (?,?,?,?,?)");

    $consultaPre->bind_param('siiss',
    $_POST["nombre"],$_POST["dia"],$_POST["mes"],$_POST["descripcion"],$_POST["concejo"]);
